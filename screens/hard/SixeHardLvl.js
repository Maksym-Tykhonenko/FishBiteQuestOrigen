...
const SixeHardLvl = ({navigation}) => {
  ...
  console.log('SixeHardLevelComplite==>', SixeHardLevelComplite);
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem(`SixeHardLvl`, jsonData);
  ...
  const goToNextLvl = () => {
    navigation.navigate('SevenHardLvl');
  };
