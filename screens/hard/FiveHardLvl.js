...
const FiveHardLvl = ({navigation}) => {
  ...
  console.log('FiveHardLevelComplite==>', FiveHardLevelComplite);
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem(`FiveHardLvl`, jsonData);
  ...
  const goToNextLvl = () => {
    navigation.navigate('SixeHardLvl');
  };
